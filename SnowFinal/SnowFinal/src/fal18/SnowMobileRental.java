...
public class SnowMobileRental extends SportShopRental{
    ...
    public double lateCharge(){
        return (20+capacity*5)/100f*this.getRentalCost();
    }
    
    @Override
    public String toString(){
        String str=super.toString();
        str+=String.format(", Capacity: %1d seat, Vin: %s",this.capacity,this.vin);
        return str;
    }
    ...
    public void setCapacity(int capacity){
        try{
            ...
            System.err.println("Capacity out of range");
        }
    }
    public void setVin(String vin){
        try{
            ...
            System.err.println("Vin cannot be more than 20 characters");
        }
    }
